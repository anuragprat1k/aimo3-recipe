...
Therefore, the answer is \\boxed{2, 3}."""
    ...
    def render_cot(self, problem: str, solution: Optional[str] = None, tokenizer=None) -> str:
        ...
        if tokenizer:
            return tokenizer.apply_chat_template(messages, tokenize=False, add_generation_prompt=(solution is None))
        return self._simple_format(messages, add_generation_prompt=(solution is None))

    def render_tir(self, problem: str, solution: Optional[str] = None, tokenizer=None) -> str:
